...
namespace Examples
{
    public class FirstPersonExample : MonoBehaviour
    {
        ...
        // New fields for animation and playtime
        Animator animator;
        float playTime;
        ...
        void Awake()
        {
            ...
            cameraTransform = Camera.main.transform;
            controller = GetComponent<CharacterController>();
            animator = GetComponentInChildren<Animator>(); // Assuming the Animator is on a child (like player model)
        }
        ...
        private void PlayerMovement(float horizontal, float vertical)
        {
            ...
            Vector3 moveDirection = myTransform.forward * vertical + myTransform.right * horizontal;
            moveDirection.y = -10f;
        ...
        // Public method to get play time (optional)
